<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-8">
        <h2><?= __('Edit Help Desk Category') ?></h2>
        <ol class="breadcrumb">
        ...
        <div class="title-action">
            <div class="btn-group btn-group-justified btn-actions">
                ...
                <div class="btn-group">
                    ...
                    $this->Form->postLink(
                        __('Delete'),
                        ['action' => 'delete', $helpDeskCategory->id],
                        ['class' => 'btn btn-sm btn-danger', 'confirm' => __('Are you sure you want to delete # {0}?', $helpDeskCategory->id)]
                    )
                    ?>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <?= $this->Form->input('category', ['class' => 'form-control', 'label' => false]) ?>
                        </div>
                    </div>
                    <div class="form-group">
