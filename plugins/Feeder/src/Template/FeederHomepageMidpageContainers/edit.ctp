<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-5">
        <h2><?= __('Edit Feeder Homepage Midpage Container') ?></h2>
        <ol class="breadcrumb">
        ...
        <div class="title-action">
            <div class="btn-group btn-group-justified btn-actions">
                ...
                <div class="btn-group">
                    ...
                    $this->Form->postLink(
                        __('Delete'),
                        ['action' => 'delete', $feederHomepageMidpageContainer->id],
                        ['class' => 'btn btn-sm btn-danger', 'confirm' => __('Are you sure you want to delete # {0}?', $feederHomepageMidpageContainer->id)]
                    )
                    ?>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group video-file-input">
                        ...
                        <div class="col-sm-1">
                            <?= $this->Html->link(__('Remove'), '', ['class' => 'btn btn-sm btn-primary',
                                'onclick' => 'document.getElementById("removed-media").value += "video_desktop_mp4,"; this.className += "disabled"; return false']) ?>
                        </div>
                        <div class="card-img-wrapper col-sm-4">
                            <?= ($file = $feederHomepageMidpageContainer->video_desktop_mp4) ?
                                $this->Html->link(
                    ...
                    <div class="form-group video-file-input">
                        ...
                        <div class="col-sm-1">
                            <?= $this->Html->link(__('Remove'), '', ['class' => 'btn btn-sm btn-primary',
                                'onclick' => 'document.getElementById("removed-media").value += "video_desktop_webm,"; this.className += "disabled"; return false']) ?>
                        </div>
                        <div class="card-img-wrapper col-sm-4">
                            <?= ($file = $feederHomepageMidpageContainer->video_desktop_webm) ?
                                $this->Html->link(
                                    '<video class="lazyload" autoplay loop muted playsinline preload="">' .
                    ...
                    <div class="form-group video-file-input">
                        ...
                        <div class="col-sm-1">
                            <?= $this->Html->link(__('Remove'), '', ['class' => 'btn btn-sm btn-primary',
                                'onclick' => 'document.getElementById("removed-media").value += "video_tablet_mp4,"; this.className += "disabled";return false']) ?>
                        </div>
                        <div class="card-img-wrapper col-sm-4">
                            <?= ($file = $feederHomepageMidpageContainer->video_tablet_mp4) ?
                                $this->Html->link(
                                    '<video class="lazyload" autoplay loop muted playsinline preload="">' .
                                    '<source src="' . $this->Url->image($file) . '" type="video/mp4">' .
                                    '</video>',
                    ...
                    <div class="form-group video-file-input">
                        ...
                        <div class="col-sm-1">
                            <?= $this->Html->link(__('Remove'), '', ['class' => 'btn btn-sm btn-primary',
                                'onclick' => 'document.getElementById("removed-media").value += "video_tablet_webm,"; this.className += "disabled";return false']) ?>
                        </div>
                        <div class="card-img-wrapper col-sm-4">
                            <?= ($file = $feederHomepageMidpageContainer->video_tablet_webm) ?
                                $this->Html->link(
                                    '<video class="lazyload" autoplay loop muted playsinline preload="">' .
                                    '<source src="' . $this->Url->image($file) . '" type="video/webm">' .
                                    '</video>',
                    ...
                    <div class="form-group video-file-input">
                        ...
                        <div class="col-sm-1">
                            <?= $this->Html->link(__('Remove'), '', ['class' => 'btn btn-sm btn-primary',
                                'onclick' => 'document.getElementById("removed-media").value += "video_mobile_mp4,"; this.className += "disabled";return false']) ?>
                        </div>
                        <div class="card-img-wrapper col-sm-4">
                            <?= ($file = $feederHomepageMidpageContainer->video_mobile_mp4) ?
                                $this->Html->link(
                                    '<video class="lazyload" autoplay loop muted playsinline preload="">' .
                                    '<source src="' . $this->Url->image($file) . '" type="video/mp4">' .
                                    '</video>',
                    ...
                    <div class="form-group video-file-input">
                        ...
                        <div class="col-sm-1">
                            <?= $this->Html->link(__('Remove'), '', ['class' => 'btn btn-sm btn-primary',
                                'onclick' => 'document.getElementById("removed-media").value += "video_mobile_webm,"; this.className += "disabled"; return false']) ?>
                        </div>
                        <div class="card-img-wrapper col-sm-4">
                            <?= ($file = $feederHomepageMidpageContainer->video_mobile_webm) ?
                                $this->Html->link(
                                    '<video class="lazyload" autoplay loop muted playsinline preload="">' .
                                    '<source src="' . $this->Url->image($file) . '" type="video/webm">' .
                                    '</video>',
                    ...
                    <div class="form-group image-file-input">
                        ...
                        <div class="col-sm-1">
                            <?= $this->Html->link(__('Remove'), '', ['class' => 'btn btn-sm btn-primary',
                                'onclick' => 'document.getElementById("removed-media").value += "image_desktop,"; this.className += "disabled"; return false']) ?>
                        </div>
                        <div class="col-sm-4">
                            <?= ($file = $feederHomepageMidpageContainer->image_desktop)
                                ? $this->Html->link(
                                    $this->Html->image($file, ['id' => 'logo', 'width' => '200px']),
                                    $this->Url->image($file),
                                    ['download' => basename($file), 'escape' => false]) : '' ?>
                        </div>
                    </div>
                    <div class="form-group image-file-input">
                        ...
                        <div class="col-sm-1">
                            <?= $this->Html->link(__('Remove'), '', ['class' => 'btn btn-sm btn-primary',
                                'onclick' => 'document.getElementById("removed-media").value += "image_tablet,"; this.className += "disabled"; return false']) ?>
                        </div>
                        <div class="col-sm-4">
                            <?= ($file = $feederHomepageMidpageContainer->image_tablet)
                                ? $this->Html->link(
                                    $this->Html->image($file, ['id' => 'logo', 'width' => '200px']),
                                    $this->Url->image($file),
                                    ['download' => basename($file), 'escape' => false]) : '' ?>
                    ...
                    <div class="form-group image-file-input">
                        ...
                        <div class="col-sm-1">
                            <?= $this->Html->link(__('Remove'), '', ['class' => 'btn btn-sm btn-primary',
                                'onclick' => 'document.getElementById("removed-media").value += "image_mobile,"; this.className += "disabled"; return false']) ?>
                        </div>
                        <div class="col-sm-4">
                            <?= ($file = $feederHomepageMidpageContainer->image_mobile)
                                ? $this->Html->link(
                                    $this->Html->image($file, ['id' => 'logo', 'width' => '200px']),
                                    $this->Url->image($file),
                                    ['download' => basename($file), 'escape' => false]) : '' ?>
...
<script>
    ...
    displayVideoFileInput($('#use-video').is(':checked'));
</script>
<?php $this->end() ?>
