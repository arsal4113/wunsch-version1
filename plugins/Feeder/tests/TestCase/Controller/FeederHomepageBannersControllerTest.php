...
use Feeder\Controller\FeederHomepageBannersController;

/**
 * Feeder\Controller\FeederHomepageBannersController Test Case
 */
class FeederHomepageBannersControllerTest extends IntegrationTestCase
{
    ...
    const CURRENT_URL = '/feeder/feeder-homepage-banners';
    private $coreUser;
