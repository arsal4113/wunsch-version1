...
return [
    ...
    'disco' => [
        /* SellerUuid*/
        'a61cf143-d020-4613-a0fa-bc8c98f523c9' => [
            'mode' => 'live',
            'ebay' => [
                'live_account_id' => '2',
                'sandbox_account_id' => '1'
            ],
            'braintree' => [
                'mode' => 'sandbox',
                'sandbox' => [
    ...
    'i-template' => [
        'imageFullUrl' => 'http://templates.i-ways.net'
    ],
    'responsive-css-prefix' => [
        'brand' => '../../',
        'default' => '../'
    ],
    'debug' => true,
    ...
    'baseUrl' => 'http://templates.i-ways.net',
    'useRegisterCaptcha' => false,
    'eBayItemDescriptionBackup' => true,
    'google_recatpcha_settings' => [
        'site_key' => '6Le3jwoUAAAAAAxcPMFRazhWXhvKTfqy5CvgkSJ_',
        'secret_key' => '6Le3jwoUAAAAAFu2T_3tCOtGau7jFs88hG0WX2MM'
    ],
    'googleMapsApi' => [
        'apiKey' => ''
    ],
    ...
    'eBayNotificationApi' => [
        ...
        'deviseType' => 'Platform',
        'endPoint' => 'http://207.154.193.252/i-template/notifications',
    ],
    /**
    ...
    'ebayFashion' => [
        'imageFullUrl' => 'http://52.28.155.13'
    ],
    'Catch' => [
        'search_page' => [
    ...
    'CheckoutSessions' => [
        'fileName' => 'ebay_checkout_sessions.csv',
        'sftpUpload' => [
            'host' => '18.184.41.166',
            'port' => '22',
            'user' => 'ebay',
            'publicKey' => 'plugins/EbayCheckout/config/ssh/ebay-sftp.pub',
            'privateKey' => 'plugins/EbayCheckout/config/ssh/ebay-sftp.pem',
            'secret' => '',
            'remotePath' => '/shared/checkout_export'
        ],
        'eisApiFeed' => [
            'token' => getenv('EIS_API_FEED_TOKEN'),
            'endpoint' => getenv('EIS_API_FEED_ENDPOINT'),
            'feedCode' => getenv('EIS_API_FEED_CODE')
        ]
    ],
    'eis' => [
