...
/**
 * Feeder\Model\Table\FeederCategoriesTable Test Case
 */
class FeederCategoriesTableTest extends TestCase
{
    /**
     * Test subject
     *
     * @var \Feeder\Model\Table\FeederCategoriesTable
     */
    public $FeederCategories;
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('FeederCategories') ? [] : ['className' => FeederCategoriesTable::class];
        $this->FeederCategories = TableRegistry::getTableLocator()->get('FeederCategories', $config);
    }
    ...
    public function testFindAll()
    {
        ...
        $this->assertInstanceOf("Cake\Orm\Query", $FeederCategories);
        $result = $FeederCategories->enableHydration(false)->toArray();
        $expected = [1];
        $idComparison = [
            $result[0]['id'],
        ];
