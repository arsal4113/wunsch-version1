    ...
    <div class="col-sm-7">
        <div class="title-action">
            <div class="btn-group btn-group-justified btn-actions">
                <div class="btn-group">
                    <?= $this->Html->link('<i class="fa fa-list"></i>' . ' ' . __('List of Feeder Categories'),
                        ['action' => 'index'], ['class' => 'btn btn-sm btn-primary', 'escape' => false]) ?>
                </div>
                <div class="btn-group">
                    <?=
                    $this->Form->postLink(
                        __('Delete'),
                        ['action' => 'delete', $feederCategory->id],
                        [
                            'class' => 'btn btn-sm btn-danger',
                            'confirm' => __('Are you sure you want to delete # {0}?', $feederCategory->id)
                        ]
                    )
                    ?>
                </div>
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox">
        <div class="ibox-content">
            <div class="row">
                <div class="col-lg-12">
                    <?= $this->Form->create($feederCategory,
                        ['class' => 'form-horizontal style-form', 'type' => 'file']); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10 image-input-field">
                                            <div class="image-preview" style="display: block;">
                                                <?= $this->Html->image($feederCategory->banner_image ?: '/', ['id' => 'banner-image-image']) ?>
                                            </div>
                                            <?php
                                            if ($feederCategory->banner_image && $imageName = explode('/', $feederCategory->banner_image ?: '')) {
                                                $imageName = end($imageName);
                                                ?>
                                                <span class="image-name"><?= $imageName ?></span>
                                                <a href="<?= strpos($feederCategory->banner_image, '://') === false ? '/img/' . $feederCategory->banner_image : $feederCategory->banner_image ?>" data-filename="<?= $imageName ?>" class="img-download-button">Download</a>
                                                <input type="checkbox" name="banner_image_delete" value="1" class="custom-checkbox" id="banner-image-delete" /> DELETE
                                                <?php
                                            }
                                            ?>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-sm-10">
                                            <?= $this->Form->input('meta_description', ['type' => 'text', 'label' => false, 'class' => 'form-control']) ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <?= $this->Form->input('title_tag', ['type' => 'text', 'label' => false, 'class' => 'form-control']) ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group" id="top-category-input" style="display: none;">
                                        ...
                                        <div class="col-sm-10">
                                            <?= $this->Form->input('top_category_id',
                                                [ 'multiple' => true, 'options' => array_combine($soldItemCategories, $soldItemCategories),
                                                    'value' => explode(';', $feederCategory->top_category_id), 'label' => false, 'class' => 'form-control']) ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10 image-input-field">
                            <?php
                            $imageName = explode('/', $feederCategory->image);
                            $imageName = end($imageName); ?>
                            <div class="image-preview" style="display: block;">
                                <?= $this->Html->image($feederCategory->image, ['id' => 'image-image']); ?>
                            </div>
                            <span class="image-name"><?= $imageName ?></span>
                            <a href="<?= strpos($feederCategory->image, '://') === false ? '/img/' . $feederCategory->image : $feederCategory->image ?>" data-filename="<?= $imageName ?>" class="img-download-button">Download</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="col-md-4 col-sm-2 control-label"><?= $this->Form->label(__('canonical_link')); ?></label>
                                <div class="col-md-8 col-sm-10">
                                    <?php
                                    $canonicalLinks = [];
                                    foreach ($categoryIds as $categoryId) {
                                        $canonicalLinks[$categoryId] = $this->Url->build(['controller' => 'Browse', 'action' => 'view', 'plugin' => 'Feeder', $categoryId], true);
                                    }
                                    ?>
                                    <?= $this->Form->input('canonical_link_category_id', ['class' => 'form-control', 'default' => $feederCategory->canonical_link_category_id ?: $feederCategory->id, 'options' => $canonicalLinks, 'label' => false]) ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group" id="video-element-input">
                                <label class="col-sm-2 control-label"><?= $this->Form->label(__('categories_video_element')); ?></label>
                                <div class="col-sm-10">
...
<script>
    $(document).ready(function () {
        ...
        let itemIdInput = $('#item-id-input'),
            ...
            articleIdCategory = <?= empty($feederCategory->item_id) ? "false" : "true" ?>,
            categoryIdCategory = <?= empty($feederCategory->ebay_category_id) ? "false" : "true" ?>;

        typeSelect.change(function () {
            changeCategoryType($(this).val());
        });
        ...
        $('#add-footer-template').click(function () {
            if (footerTemplateInput.val() === '') {
                ...
                footerTemplateInput.val(
                    ...
                    '            <h3>[1. Teilüberschrift linke Seite</span>]</h3>\n' +
                    '            <p>[Erster Paragraph <span class="bold-font">linke Seite</span>]</p>\n' +
                    '        </div>\n' +
                    '        <div class="footer-text">\n' +
        ...
        $('#image, #banner-image, #image-selected, #animated-header-image').change(function () {
            ...
            img.onload = function () {
                ...
                input.closest('.form-group').find(".image-name").html(file.name);
                input.closest('.form-group').find("a").html("Download (old)").show();
            };
        ...
        $('.img-download-button').click(function (e) {
            e.preventDefault();
        ...
        var positionPreview = $('.position-preview');
