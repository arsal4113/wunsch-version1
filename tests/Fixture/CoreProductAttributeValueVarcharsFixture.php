...
/**
 * CoreProductAttributeValueVarcharsFixture
 */
class CoreProductAttributeValueVarcharsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'core_product_attribute_value_varchars_ibfk_1' => ['type' => 'foreign', 'columns' => ['core_product_id'], 'references' => ['core_products', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
            'core_product_attribute_value_varchars_ibfk_2' => ['type' => 'foreign', 'columns' => ['core_product_eav_attribute_id'], 'references' => ['core_product_eav_attributes', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
            'core_product_attribute_value_varchars_ibfk_3' => ['type' => 'foreign', 'columns' => ['core_marketplace_id'], 'references' => ['core_marketplaces', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-12-17 05:18:45',
                'modified' => '2020-12-17 05:18:45',
            ],
        ];
        parent::init();
    }
