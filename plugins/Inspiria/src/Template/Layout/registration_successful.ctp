...
<h2 class="text-center white margin-top-100"><?= __('Welcome to eBay Template Creator') ?></h2>
<h4 class="text-center margin-top-10" style="color:#ccc; font-size: 150%;"><?= __('in cooperation with eBay') ?></h4>
<div class="middle-box loginscreen animated fadeInDown">
    <div>
        <h3 class="margin-bottom-20 text-center white"><?= __('Thank You for signing up!') ?></h3>

        <?= $this->Flash->render('auth') ?>
        <?= $this->Flash->render() ?>
        <?= $this->fetch('content') ?>

        <p class="m-t text-center margin-top-20 white">
