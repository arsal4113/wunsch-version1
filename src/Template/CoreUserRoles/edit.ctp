    ...
    <div class="col-sm-7">
        <div class="title-action">
            <div class="btn-group btn-group-justified btn-actions">
                <div class="btn-group">
                    <?= $this->Html->link('<i class="fa fa-list"></i>' . ' ' . __('List of User Roles'), ['action' => 'index'], ['class' => 'btn btn-sm btn-primary', 'escape' => false]) ?>
                </div>
                <div class="btn-group">
                    <?=
                    $this->Form->postLink(
                        __('Delete'),
                        ['action' => 'delete', $coreUserRole->id],
                        ['class' => 'btn btn-sm btn-danger', 'confirm' => __('Are you sure you want to delete # {0}?', $coreUserRole->id)]
                    )
                    ?>
                </div>
            </div>
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox">
        <div class="ibox-content">
            <div class="row">
                <div class="col-lg-12">
                    <?= $this->Form->create($coreUserRole, ['class' => 'form-horizontal style-form']); ?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><?= $this->Form->label(__('Users')); ?></label>
                        <div class="col-sm-10">
                            <?= $this->Form->input('core_users._ids', ['options' => $coreUsers, 'empty' => true, 'label' => false, 'class' => 'form-control']) ?>
                        </div>
                    </div>
