        ...
        <div class="ibox-content">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><?= $this->Form->label('first_name'); ?></label>
                        <div class="col-sm-10">
                            <?= $this->Form->input('first_name', ['label' => false, 'class' => 'form-control']) ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><?= $this->Form->label('last_name'); ?></label>
                        <div class="col-sm-10">
                            <?= $this->Form->input('last_name', ['label' => false, 'class' => 'form-control']) ?>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?= $this->Form->input('password', ['type' => 'password', 'label' => false, 'class' => 'form-control']) ?>
                        </div>
                    </div>
                    <div class="form-group">
