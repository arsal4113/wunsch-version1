    ...
    <div class="col-sm-7">
        <div class="title-action">
            <div class="btn-group btn-group-justified btn-actions">
                <div class="btn-group">
                    <?= $this->Html->link('<i class="fa fa-list"></i>' . ' ' . __('List of Sellers'), ['action' => 'index'], ['class' => 'btn btn-sm btn-primary', 'escape' => false]) ?>
                </div>
                <div class="btn-group">
                    <?=
                    $this->Form->postLink(
                        __('Delete'),
                        ['action' => 'delete', $coreSeller->id],
                        ['class' => 'btn btn-sm btn-danger', 'confirm' => __('Are you sure you want to delete # {0}?', $coreSeller->id)]
                    )
                    ?>
                </div>
            </div>
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox">
        <div class="ibox-content">
            <div class="row">
                <div class="col-lg-12">
                    <?= $this->Form->create($coreSeller, ['class' => 'form-horizontal style-form']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?= $this->Form->input('core_language_id', ['label' => false, 'class' => 'form-control', 'options' => $coreLanguages]) ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><?= $this->Form->label(__('Country')); ?></label>
                        <div class="col-sm-10">
                            <?= $this->Form->input('core_country_id', ['label' => false, 'class' => 'form-control', 'options' => $coreCountries]) ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><?= $this->Form->label(__('Status')); ?></label>
                        <div class="col-sm-10">
                            <div class="i-checks">
