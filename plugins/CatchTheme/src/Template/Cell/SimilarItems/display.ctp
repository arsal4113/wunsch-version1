...
if (!empty($similarItems)) {
    ?>
    <!--div class="container-fluid" id="similar-items-row"-->
    <div class="col-12" id="similar-items-row">
        <!--div class="row">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 sick-slide-wrapper"-->
                        <div class="sick-slide-wrapper" id="similar-items-carousel">
                            <?php foreach ($similarItems as $key => $item) : ?>
                                <?php
                                            ...
                                            <div class="row card-body">
                                                <p class="card-price col-12">
                                                    ...
                                                    <span class="item-price <?php if (isset($item->original_price) && $item->price != $item->original_price) {
                                                        echo "item-savings";} ?>"><?= \Cake\I18n\Number::currency($item->price, $item->currency); ?></span>
    ...
    <script>
        $(function () {
            $('#similar-items-carousel').on('init', function(event, slick){
            ...
            $('#similar-items-carousel').on('afterChange', function (slick, currentSlide) {
...
?>
<script type="text/javascript">
    let similarItemsList = <?= json_encode($similarItems) ?>;
</script>
