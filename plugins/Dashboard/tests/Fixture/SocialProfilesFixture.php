...
class SocialProfilesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'social_profiles_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['customers', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'email_verified' => 1,
                'created' => '2021-01-05 23:13:28',
                'modified' => '2021-01-05 23:13:28',
            ],
        ];
        parent::init();
    }
