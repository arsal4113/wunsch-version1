    ...
    <div class="col-sm-4">
        <div class="title-action">
            <div class="btn-group btn-group-justified btn-actions">
                <div class="btn-group">
                    <?= $this->Html->link('<i class="fa fa-list"></i>' . ' ' . __('List of Feeder Guides'), ['action' => 'index'], ['class' => 'btn btn-sm btn-primary', 'escape' => false]) ?>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="image-preview">
                            <?= $this->Html->image($feederGuide->animation_image, ['id' => 'first-background-image-display']); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-2"></div>
                        <div class="image-preview">
                            <?= $this->Html->image($feederGuide->animation_image, ['id' => 'second-background-image-display']); ?>
                        </div>
                    </div>
                    <div class="form-group">
