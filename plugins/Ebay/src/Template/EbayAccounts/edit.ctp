        ...
        <div class="title-action">
            <div class="btn-group btn-group-justified btn-actions">
                ...
                <div class="btn-group">
                    ...
                    $this->Form->postLink(
                        __('Delete'),
                        ['action' => 'delete', $ebayAccount->id],
                        ['class' => 'btn btn-sm btn-danger', 'confirm' => __('Are you sure you want to delete # {0}?', $ebayAccount->id)]
                    )
                    ?>
                </div>
            </div>
        ...
        <div class="ibox-content">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><?= $this->Form->label(__('token')); ?></label>
                        <div class="col-sm-10">
                            <?= $this->Form->input('token', ['label' => false, 'class' => 'form-control']) ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><?= $this->Form->label(__('token_expiration_time')); ?></label>
                        <div class="col-sm-10">
                            <?= $this->Form->input('token_expiration_time', ['label' => false, 'class' => 'form-control']) ?>
                        </div>
                    </div>
                    <div class="form-group">
