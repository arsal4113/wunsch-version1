<div class="row mt">
    <div class="col-lg-8">
        <h3><i class="fa fa-angle-right"></i> <?= __('Edit Core Error Notification Profile') ?></h3>
    </div>
    <div class="col-lg-4">
        <div class="btn-group btn-group-justified btn-actions">
            ...
            <div class="btn-group">
                <?= 
                    $this->Form->postLink(
                        __('Delete'),
                        ['action' => 'delete', $coreErrorNotificationProfile->id],
                        ['class' => 'btn btn-sm btn-danger', 'confirm' => __('Are you sure you want to delete # {0}?', $coreErrorNotificationProfile->id)]
                    )
                   ?>
            </div>
        </div>
