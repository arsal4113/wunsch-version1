<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-5">
        <h2><?= __('Edit Feeder Influencer') ?></h2>
        <ol class="breadcrumb">
        ...
        <div class="title-action">
            <div class="btn-group btn-group-justified btn-actions">
                ...
                <div class="btn-group">
                    ...
                    $this->Form->postLink(
                        __('Delete'),
                        ['action' => 'delete', $feederInfluencer->id],
                        ['class' => 'btn btn-sm btn-danger', 'confirm' => __('Are you sure you want to delete # {0}?', $feederInfluencer->id)]
                    )
                    ?>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <?= $this->Form->input('area_3_image', ['label' => false, 'class' => 'form-control file-upload', 'type' => 'file']) ?>
                        </div>
                        <div class="col-sm-4">
                            <?php
                            if ($feederInfluencer->area_3_image) {
                                echo $this->Html->image($feederInfluencer->area_3_image, ['class' => 'preview-image', 'width' => '200px']);
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <?php
                            if ($feederInfluencer->area_5_image_1) {
                                echo $this->Html->image($feederInfluencer->area_5_image_1, ['class' => 'preview-image', 'width' => '200px']);
                                echo '<input type="button" class="btn btn-sm btn-primary remove-button m" value="' . __('Remove') . '">';
                            } else {
                                echo $this->Html->image('', ['style' => 'display: none', 'class' => 'preview-image', 'width' => '200px']);
                            }
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <?php
                            if ($feederInfluencer->area_5_image_2) {
                                echo $this->Html->image($feederInfluencer->area_5_image_2, ['class' => 'preview-image', 'width' => '200px']);
                                echo '<input type="button" class="btn btn-sm btn-primary remove-button m" value="' . __('Remove') . '">';
                            } else {
                                echo $this->Html->image('', ['style' => 'display: none', 'class' => 'preview-image', 'width' => '200px']);
                            }
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <?php
                            if ($feederInfluencer->area_5_image_3) {
                                echo $this->Html->image($feederInfluencer->area_5_image_3, ['class' => 'preview-image', 'width' => '200px']);
                                echo '<input type="button" class="btn btn-sm btn-primary remove-button m" value="' . __('Remove') . '">';
                            } else {
                                echo $this->Html->image('', ['style' => 'display: none', 'class' => 'preview-image', 'width' => '200px']);
                            }
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <?php
                            if ($feederInfluencer->area_5_image_4) {
                                echo $this->Html->image($feederInfluencer->area_5_image_4, ['class' => 'preview-image', 'width' => '200px']);
                                echo '<input type="button" class="btn btn-sm btn-primary remove-button m" value="' . __('Remove') . '">';
                            } else {
                                echo $this->Html->image('', ['style' => 'display: none', 'class' => 'preview-image', 'width' => '200px']);
                            }
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <?php
                            if ($feederInfluencer->area_5_image_5) {
                                echo $this->Html->image($feederInfluencer->area_5_image_5, ['class' => 'preview-image', 'width' => '200px']);
                                echo '<input type="button" class="btn btn-sm btn-primary remove-button m" value="' . __('Remove') . '">';
                            } else {
                                echo $this->Html->image('', ['style' => 'display: none', 'class' => 'preview-image', 'width' => '200px']);
                            }
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <?php
                            if ($feederInfluencer->area_5_image_6) {
                                echo $this->Html->image($feederInfluencer->area_5_image_6, ['class' => 'preview-image', 'width' => '200px']);
                                echo '<input type="button" class="btn btn-sm btn-primary remove-button m" value="' . __('Remove') . '">';
                            } else {
                                echo $this->Html->image('', ['style' => 'display: none', 'class' => 'preview-image', 'width' => '200px']);
                            }
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <?php
                            if ($feederInfluencer->area_6_image_1) {
                                echo $this->Html->image($feederInfluencer->area_6_image_1, ['class' => 'preview-image', 'width' => '200px']);
                                echo '<input type="button" class="btn btn-sm btn-primary remove-button m" value="' . __('Remove') . '">';
                            } else {
                                echo $this->Html->image('', ['style' => 'display: none', 'class' => 'preview-image', 'width' => '200px']);
                            }
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <?php
                            if ($feederInfluencer->area_6_image_2) {
                                echo $this->Html->image($feederInfluencer->area_6_image_2, ['class' => 'preview-image', 'width' => '200px']);
                                echo '<input type="button" class="btn btn-sm btn-primary remove-button m" value="' . __('Remove') . '">';
                            } else {
                                echo $this->Html->image('', ['style' => 'display: none', 'class' => 'preview-image', 'width' => '200px']);
                            }
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <?php
                            if ($feederInfluencer->area_6_image_3) {
                                echo $this->Html->image($feederInfluencer->area_6_image_3, ['class' => 'preview-image', 'width' => '200px']);
                                echo '<input type="button" class="btn btn-sm btn-primary remove-button m" value="' . __('Remove') . '">';
                            } else {
                                echo $this->Html->image('', ['style' => 'display: none', 'class' => 'preview-image', 'width' => '200px']);
                            }
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <?php
                            if ($feederInfluencer->area_8_image) {
                                echo $this->Html->image($feederInfluencer->area_8_image, ['class' => 'preview-image', 'width' => '200px']);
                                echo '<input type="button" class="btn btn-sm btn-primary remove-button m" value="' . __('Remove') . '">';
                            } else {
                                echo $this->Html->image('', ['style' => 'display: none', 'class' => 'preview-image', 'width' => '200px']);
                            }
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <?php
                            if ($feederInfluencer->area_9_image) {
                                echo $this->Html->image($feederInfluencer->area_9_image, ['class' => 'preview-image', 'width' => '200px']);
                                echo '<input type="button" class="btn btn-sm btn-primary remove-button m" value="' . __('Remove') . '">';
                            } else {
                                echo $this->Html->image('', ['style' => 'display: none', 'class' => 'preview-image', 'width' => '200px']);
                            }
        ...
        function previewFileUpload() {
            ...
            if (this.files && this.files[0]) {
                ...
                reader.onload = function (e) {
                    const previewImage = `<img src="${e.target.result}" class="preview-image" style="width: 200px"/>`;
                    ...
                    if (input.closest('.form-group').find('.remove-button').length === 0) {
                        input.parent().parent().next('div').append(previewImage).append(removeButton);
                    }
                };
