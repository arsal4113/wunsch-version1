...
<?= $this->Form->hidden('core_seller_id', ['value' => $coreCustomer->core_seller_id]) ?>
<?= $this->Form->hidden('core_customer_id', ['value' => $coreCustomer->id]) ?>
...
<div class="col-lg-5">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <?= $this->Form->input('firstname', ['label' => false, 'class' => 'form-control', 'value' => $coreCustomer->firstname]) ?>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label"><?= $this->Form->label(__('lastname')); ?></label>
        <div class="col-sm-10">
            <?= $this->Form->input('lastname', ['label' => false, 'class' => 'form-control', 'value' => $coreCustomer->lastname]) ?>
        </div>
    </div>
    <div class="form-group">
...
<div class="col-lg-12">
    ...
    <div class="form-group">
        <div class="col-sm-4 col-sm-offset-8">
            <?= $this->Form->submit(__('Save new address'), ['id' => 'save-address', 'class' => 'btn btn-sm btn-primary pull-right', 'data-url' => '/core_customer_addresses/add/' . $coreCustomer->id]) ?>
        </div>
    </div>
</div>
<?= $this->Form->end() ?>
